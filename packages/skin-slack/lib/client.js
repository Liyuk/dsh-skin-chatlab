(() => {
  ...
  // packages/skin-slack/src/slack.js
  var SLACK_BRAND_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><rect width="24" height="24" rx="6" fill="#26343b"></rect><path d="M7 7.5c0-1.4 1.1-2.5 2.5-2.5H17v3h-7v2.5h4.5A2.5 2.5 0 0 1 17 13v3.5c0 1.4-1.1 2.5-2.5 2.5H7v-3h7v-2.5H9.5A2.5 2.5 0 0 1 7 11V7.5Z" fill="#72c3cc"></path><circle cx="18.5" cy="5.5" r="1.5" fill="#f28b82"></circle></svg>';
  var SLACK_TOKENS = makeTokens({
    light: {
      accent: "#611f69",
      accentHover: "#4a154b",
      accentMuted: "#f1e8f3",
...
`;
  ...
  // packages/skin-slack/src/index.js
  window.__ModuleLoader__.load({
    ...
    factory: function() {
      ...
      return { name: "@liyuk/dsh-skin-slack", inject: ["chatlab"], apply };
    }
  });
})();
